...
@testset "dh basics" begin
    ...
    a_priv = big"4"
    b_priv = big"3"
    a_private_key, a_public_key = ToyPublicKeys.generate_dh_key_pair(s_modulus, s_public, a_priv)
    b_private_key, b_public_key = ToyPublicKeys.generate_dh_key_pair(s_modulus, s_public, b_priv)
